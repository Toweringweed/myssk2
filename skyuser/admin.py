...
class UserApplyAdmin(admin.ModelAdmin):
    ...
    fields = ['uid', 'data_year', 'goal', 'certificate', 'apply_date', 'result', 'result_why', 'why_des', 'check_date']
    readonly_fields = ['uid', 'data_year', 'goal', 'apply_date', 'certificate']
    ordering = ['-apply_date', 'result']
